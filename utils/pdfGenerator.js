...
function gerarRelatorioAnexoI(equipamentos, ordens, configSite, numeroCiclo) {
  ...
  return `
    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; }
        ...
        ${cssCabecalhoOficial()}
        .base-legal { font-size: 9.5px; color: #5B6B7A; margin-top: 4px; }
        ...
        .ficha td.rotulo { background: #EEF3F8; font-weight: 600; width: 22%; color: #10263D; }
        .secao-titulo { font-size: 13px; text-transform: uppercase; color: #10263D; border-bottom: 1px solid #10263D; padding-bottom: 4px; margin: 22px 0 10px; }
        .secao-predio { font-size: 11.5px; color: #10263D; margin: 14px 0 6px; }
        ...
        .tabela-anexo th { background: #10263D; color: #fff; text-transform: uppercase; font-size: 8.5px; }
    ...
    <body>
      ${cabecalhoOficialHtml('Plano de Manutenção, Operação e Controle (PMOC)')}
